    ...
    <div className="min-h-screen bg-stone-950 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-white font-black text-4xl leading-none" style={{ fontFamily:"'Bebas Neue','Impact',sans-serif", letterSpacing:"0.06em" }}>Alpine To Island Adventures</h1>
