    ...
    <section id="reviews" className="bg-stone-50 py-28 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-stone-500 text-xl max-w-xl mx-auto" style={{ fontFamily:"'DM Sans',sans-serif" }}>Hear from travelers who experienced unforgettable adventures with us in Theligama.</p>
        </div>
